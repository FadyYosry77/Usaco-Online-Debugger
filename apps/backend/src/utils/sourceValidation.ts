...
export function validateCppSourceSnapshot(sourceCode: string): SourceValidationResult {
...
export function analyzeCppSourceSnapshot(sourceCode: string): string[] {
  const source = sourceCode.trim();
...
function findMissingTemplateAliases(source: string): string[] {
